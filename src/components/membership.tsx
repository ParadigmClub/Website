      ...
      <div className="mx-auto max-w-7xl">
          ...
          {sections.map((section) => (
            <div
              ...
              className={`bg-gradient-to-br from-[#1A1A1A] to-[#2A2A2A] rounded-3xl p-8 transition-all duration-300 ${
                activeSection === section.id ? 'ring-2 ring-cyan-400 shadow-lg shadow-cyan-400/20' : ''
              }`}
              onMouseEnter={() => setActiveSection(section.id)}
            >
              <div className="flex items-center mb-4">
                <section.icon className={`w-8 h-8 mr-4 ${activeSection === section.id ? 'text-cyan-400' : 'text-[#9AFF27]'}`} />
        ...
        <div className="bg-gradient-to-r from-cyan-400 to-[#9AFF27] p-1 rounded-3xl transform hover:scale-105 transition-transform duration-300">
          <div className="bg-[#0F0A0A] rounded-3xl p-8 relative overflow-hidden">
            ...
            <h2 className="relative z-10 mb-6 text-3xl font-bold text-center text-cyan-400">Get in Touch</h2>
            <div className="relative z-10 grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="flex items-center bg-[#1A1A1A] p-4 rounded-xl">
                <Mail className="w-6 h-6 mr-4 text-[#9AFF27]" />
                <a href="mailto:contact@paradigmtech.club" className="transition-colors hover:text-cyan-400">contact@paradigmtech.club</a>
              </div>
              <div className="flex items-center bg-[#1A1A1A] p-4 rounded-xl">
                <Phone className="w-6 h-6 mr-4 text-[#9AFF27]" />
                <a href="tel:+1234567890" className="transition-colors hover:text-cyan-400">+1 (234) 567-890</a>
              </div>
              <div className="flex items-center bg-[#1A1A1A] p-4 rounded-xl">
            ...
            <div className="relative z-10 flex justify-center mt-8 space-x-6">
              <a href="https://github.com/paradigm-tech" target="_blank" rel="noopener noreferrer" className="text-[#FCFCFC] hover:text-cyan-400 transition-colors">
                <Github className="w-8 h-8" />
              </a>
              <a href="https://linkedin.com/company/paradigm-tech" target="_blank" rel="noopener noreferrer" className="text-[#FCFCFC] hover:text-cyan-400 transition-colors">
                <Linkedin className="w-8 h-8" />
              </a>
              <a href="https://twitter.com/paradigm_tech" target="_blank" rel="noopener noreferrer" className="text-[#FCFCFC] hover:text-cyan-400 transition-colors">
